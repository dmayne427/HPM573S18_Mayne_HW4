...
print('The minimum reward you can expect to see while playing this game is:', games.get_min())
print('The maximum reward you can expect to see while playing this game is:', games.get_max())



# plot the histogram
Fig.graph_histogram(
    observations=games.get_list(),
